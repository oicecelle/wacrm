                          ...
                          {doc.status === "pending" && doc.public_token && (
                            <>
                              ...
                              <button
                                ...
                                className="p-2 border border-border hover:bg-neutral-50 text-emerald-600 rounded-lg transition-colors flex items-center justify-center cursor-pointer bg-transparent"
