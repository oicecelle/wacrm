...
export async function middleware(request: NextRequest) {
  ...
  const protectedPaths = ['/dashboard', '/inbox', '/contacts', '/pipelines', '/broadcasts', '/automations', '/settings', '/agenda', '/financeiro', '/documentos', '/equipe', '/servicos', '/relatorios', '/onboarding', '/selecionar-clinica']
